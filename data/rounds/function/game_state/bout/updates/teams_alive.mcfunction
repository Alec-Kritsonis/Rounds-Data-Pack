...
execute as @e[tag=alive,team=Red] run scoreboard players add red_alive Bout_Variables 1
execute as @e[tag=alive,team=Blue] run scoreboard players add blue_alive Bout_Variables 1
execute as @e[tag=alive,team=Yellow] run scoreboard players add yellow_alive Bout_Variables 1
execute as @e[tag=alive,team=Green] run scoreboard players add green_alive Bout_Variables 1
