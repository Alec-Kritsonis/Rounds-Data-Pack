...
data merge entity @e[type=minecraft:item_display,tag=pick_card_current,limit=1] {item:{id:"minecraft:splash_potion",components:{enchantment_glint_override:false}}}
